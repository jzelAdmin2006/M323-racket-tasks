...
#reader(lib "vanilla-reader.rkt" "deinprogramm" "sdp")((modname TaskGroup2) (read-case-sensitive #f) (teachpacks ((lib "image.rkt" "teachpack" "deinprogramm" "sdp"))) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ((lib "image.rkt" "teachpack" "deinprogramm" "sdp")))))
...
(: multiply-by-5 (number -> number))

(check-expect (multiply-by-5 5) 25)
(check-expect (multiply-by-5 0) 0)
(check-expect (multiply-by-5 10) 50)
(check-expect (multiply-by-5 0.5) 2.5)
(check-expect (multiply-by-5 12) 60)
(check-expect (multiply-by-5 1) 5)
(check-expect (multiply-by-5 49) 245)
(check-expect (list-map multiply-by-5 (list 1 2 5 0 10 6 45)) (list 5 10 25 0 50 30 225))
...
; Primfaktoren einer Zahl finden
(: prime-factors (natural -> (list-of natural)))

(check-expect (prime-factors 19) (list 19))
(check-expect (prime-factors 1) (list))
(check-expect (prime-factors 0) (list))
(check-expect (prime-factors 10) (list 2 5))
(check-expect (prime-factors 16) (list 2 2 2 2))
(check-expect (prime-factors 18) (list 2 3 3))
(check-expect (prime-factors 718934) (list 2 23 15629))
(check-expect (prime-factors 718934) (list 2 23 15629))
(check-expect 
 (list-map prime-factors (list 1000 1024 1056 1100 123456789))
 (list 
  (list 2 2 2 5 5 5)
    ...
    (define prime-factors-helper
      (lambda (n divisor)
        (cond
          ...
          [else (prime-factors-helper n (+ divisor 1))])))
