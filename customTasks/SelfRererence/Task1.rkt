...
#reader(lib "beginner-reader.rkt" "deinprogramm" "sdp")((modname Task1) (read-case-sensitive #f) (teachpacks ()) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ())))
