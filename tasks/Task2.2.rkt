...
#reader(lib "vanilla-reader.rkt" "deinprogramm" "sdp")((modname Task2.2) (read-case-sensitive #f) (teachpacks ()) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ())))
; Zahl zu Text machen
